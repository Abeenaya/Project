...
public class EventDAO {
	...
	public Event getEvent(int eventId, int sessionId)
			throws ClassNotFoundException, SQLException {System.out.println("Hereeeeee in Get Event");
		connection = FERSDataConnection.createConnection();
...
event.setName(resultSet.getString(2));
		...
		System.out.println("IN GET EVENT EVENT DAO");
		return event;
	}
	...
	public int updateEvent(Event updateEvent) throws ClassNotFoundException,
		...
		System.out.println("Update Event 1");
		...
		int status =statement.executeUpdate();
		System.out.println("Update Event 2");
		PreparedStatement pre = connection.prepareStatement(query.getUpdateEventSession());
	...
	public int insertEvent(Event insertEvent) throws ClassNotFoundException,
			SQLException {System.out.println("ssssssssssssssssscccccccccccccccccc");
		connection = FERSDataConnection.createConnection();
		...
		int status = statement.executeUpdate();
		System.out.println(status+"ssssssssssssssssssssssss");
	...
	public int deleteEvent(int eventId, int sessionId)
		...
		PreparedStatement	statement1 = connection.prepareStatement(query.getDeleteEvent());
...
if(i==1&&y==1){
	...
	public List<EventCoordinator> getEventCoordinator()
			throws ClassNotFoundException, SQLException {
		System.out.println("getEventCoordinator Event Dao llllllllllllllllllllllllllllll");
...
statement = connection.prepareStatement(query.getSelectEventCoordinator());
		...
		System.out.println("getEventCoordinator Event Dao 222222222222222222222222222222222");
		while(resultSet.next()){
			eventcoordinator=new EventCoordinator();
			eventcoordinator.setEventcoordinatorid(resultSet.getInt(1));
			eventcoordinator.setUserName(resultSet.getString(2));
			eventcoordinator.setPassword(resultSet.getString(3));
			eventcoordinator.setFirstName(resultSet.getString(4));
			eventcoordinator.setLastName(resultSet.getString(5));
			eventcoordinator.setEmail(resultSet.getString(6));
			eventcoordinator.setPhoneNumber(resultSet.getString(7));
			eventcoordinator.setPlaces(resultSet.getString(8));
		
		eventCoordinatorList.add(eventcoordinator);
		}
		System.out.println("getEventCoordinator Event Dao 3333333333333333333333333333");
